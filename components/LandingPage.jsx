...
// No need to import DomeGallery as it won't be used for this approach
...
export function LandingPage({ onShowAuth }) {
  ...
  const testimonials = [
    ...
    // Add more testimonials here for the scroll effect to be visible
    {
      name: "Ravi Patel",
      role: "Farmer",
      rating: 5,
      comment: "The real-time market data is a game-changer. I can now sell my produce at the best possible price."
    },
    {
      name: "Shreya Shah",
      role: "Food Processing Company",
      rating: 5,
      comment: "Sourcing verified produce is now seamless and secure. HarvestHub is an essential tool for our business."
    }
  ];

  return (
    <div className="min-h-screen relative overflow-hidden">
      {/* MagicBento as a full-page animated background */}
      <MagicBento
        className="fixed inset-0 w-full h-full z-0 opacity-80 pointer-events-none"
        backgroundOnly={true}
      />
      ...
      <div className="relative z-10">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <h1 className="text-4xl lg:text-6xl font-bold mb-6 text-black">
                  <BlurText text="Ready to Transform Your Agricultural Business?" />
                </h1>
        ...
        {/* Testimonials - Modified to be a horizontal, scrollable gallery */}
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl lg:text-4xl font-bold mb-4">
            ...
            {/* New container for a carousel-like effect */}
            <div className="flex space-x-8 overflow-x-auto p-4 -mx-4 snap-x snap-mandatory">
              {testimonials.map((testimonial, index) => (
                <Card 
                  key={index} 
                  className="hover:shadow-lg transition-shadow min-w-[300px] snap-center shrink-0"
                >
                  <CardHeader>
